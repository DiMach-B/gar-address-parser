...
public class AS_OPERATION_TYPES extends AbstractGarTableStructure {
    public AS_OPERATION_TYPES() {
        super();
    }
    ...
    private String XmlNodeName = "OPERATIONTYPE";
    private String sql = "insert into fias2.OPERATIONTYPE (ID, NAME, SHORTNAME, THE_DESC, UPDATEDATE, STARTDATE, ENDDATE, ISACTIVE)\n" +
            "values (:ID, :NAME, :SHORTNAME, :THE_DESC, :UPDATEDATE, :STARTDATE, :ENDDATE, :ISACTIVE)\n";

    private String sqlUpdate = "UPDATE fias2.OPERATIONTYPE SET ID=:ID, NAME=:NAME, SHORTNAME=:SHORTNAME, THE_DESC=:THE_DESC, UPDATEDATE=:UPDATEDATE, " +
