...
public class AS_ROOMS extends AbstractGarTableStructure {
    public AS_ROOMS() {
        super();
    }
    ...
    private String XmlNodeName = "ROOM";
    private String sql = "insert into fias2.ROOM (ID, OBJECTID, OBJECTGUID, CHANGEID, THE_NUMBER, ROOMTYPE, OPERTYPEID, PREVID, NEXTID, UPDATEDATE, STARTDATE, ENDDATE, ISACTUAL, ISACTIVE)\n" +
            "values (:ID, :OBJECTID, :OBJECTGUID, :CHANGEID, :THE_NUMBER, :ROOMTYPE, :OPERTYPEID, :PREVID, :NEXTID, :UPDATEDATE, :STARTDATE, :ENDDATE, :ISACTUAL, :ISACTIVE)\n";

    private String sqlUpdate = "UPDATE fias2.room SET ID=:ID, OBJECTID=:OBJECTID, OBJECTGUID=:OBJECTGUID, CHANGEID=:CHANGEID," +
            " THE_NUMBER=:THE_NUMBER, ROOMTYPE=:ROOMTYPE, OPERTYPEID=:OPERTYPEID, PREVID=:PREVID," +
    ...
    public int SetAttributes(Attributes attributes) {
        ...
        ROOMTYPE = Integer.parseInt(attributes.getValue("ROOMTYPE"));
    ...
    public int SetPS(OraclePreparedStatement dbps) {
        try {
            ...
            SetParameterInt(dbps, "ROOMTYPE", ROOMTYPE);
    ...
    public int SetPSUpdate(OraclePreparedStatement dbpsUpdate, Integer IdElement) {
        try {
            ...
            SetParameterInt(dbpsUpdate, "ROOMTYPE", ROOMTYPE);
