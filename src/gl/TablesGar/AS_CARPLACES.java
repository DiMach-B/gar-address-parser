...
public class AS_CARPLACES extends AbstractGarTableStructure {
    public AS_CARPLACES() {
        super();
    }
    ...
    private String XmlNodeName = "CARPLACE";
    private String sql = "insert into fias2.CARPLACE (ID, OBJECTID, OBJECTGUID, CHANGEID, THE_NUMBER, OPERTYPEID, PREVID, NEXTID, UPDATEDATE, STARTDATE, ENDDATE, ISACTUAL, ISACTIVE)\n" +
    ...
    private String sqlUpdate = "UPDATE fias2.CARPLACE SET ID=:ID, OBJECTID=:OBJECTID, OBJECTGUID=:OBJECTGUID, CHANGEID=:CHANGEID, THE_NUMBER=:THE_NUMBER, OPERTYPEID=:OPERTYPEID, PREVID=:PREVID, " +
