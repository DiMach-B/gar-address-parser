...
public class AS_HOUSE_TYPES extends AbstractGarTableStructure {
    public AS_HOUSE_TYPES() {
        super();
    }
    ...
    private String sql = "insert into fias2.HOUSETYPE (ID, NAME, SHORTNAME, THE_DESC, UPDATEDATE, STARTDATE, ENDDATE, ISACTIVE)\n" +
            "values (:ID, :NAME, :SHORTNAME, :THE_DESC, :UPDATEDATE, :STARTDATE, :ENDDATE, :ISACTIVE)\n";

    private String sqlUpdate = "UPDATE fias2.HOUSETYPE SET ID=:ID, NAME=:NAME, SHORTNAME=:SHORTNAME, THE_DESC=:THE_DESC," +
