...
public class AS_APARTMENT_TYPES extends AbstractGarTableStructure {
    public AS_APARTMENT_TYPES() {
        super();
    }
    ...
    private String XmlNodeName = "APARTMENTTYPE";
    private String sql = "insert into fias2.APARTMENTTYPE (ID, NAME, SHORTNAME, THE_DESC, UPDATEDATE, STARTDATE, ENDDATE, ISACTIVE)\n" +
            "values (:ID, :NAME, :SHORTNAME, :THE_DESC, :UPDATEDATE, :STARTDATE, :ENDDATE, :ISACTIVE)\n";

    private String sqlUpdate = "UPDATE fias2.APARTMENTTYPE SET ID=:ID, NAME=:NAME, SHORTNAME=:SHORTNAME, THE_DESC=:THE_DESC," +
